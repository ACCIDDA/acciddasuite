...
In this step, we provide a decision tree to assist with directing you toward a forecasting approach using available data and considering the data limitations. **Figure 1** describes the important initial questions needed to use existing forecasting resources or prepare to collect data for conducting your forecast. **Figure 2** describes the process and neccisary steps to collect and organize the required data to conduct a forecast.  
...
```{r, echo=FALSE}
#| fig.cap: "Figure 1. Initial forecast selection."
#| fig.width: 14
#| fig.height: 10
#| out.width: "100%"
#| out.height: "100%"
...
```{r, echo=FALSE}
#| fig.cap: "Figure 2. Data collection and reporting workflow."
#| fig.width: 14
#| fig.height: 10
#| out.width: "100%"
#| out.height: "100%"
