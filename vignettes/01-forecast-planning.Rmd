---
title: "1. Disease Forecast Planning for Public Health"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Forecast Planning for Public Health: Define Your Approach}
...
1. What is the question that you are attempting to answer? Or what information are you seeking?

  - Determine what it is you are trying to gain from the forecasting project. Being specific here may be more useful in determining your approach. 
  - For example, 

2. Who is the audience or who is requesting the information?
...
1. What *pathogen(s)* are you interested in forecasting?
...
2. What are you interested in forecasting? This is also referred to as the *target*.
...
Some examples of forecasting targets:
  ...
  - Hospital Admissions
  - Deaths
  - Emergency Department (ED) visits related to disease-like illnesses
  
3. What *spatial unit* are you interested in forecasting? 

This may include, but are not limited to:

  - State, county, city, health jurisdiction, hospital system, or even facility
  
4. What *time resolution* are you interested in forecasting? 
